...
typedef struct bonfire_warp_param_s {
    ...
    unsigned short bonfireSubCategorySortId;

    /* ワープ禁止アイコンID
     *   ワープ禁止時のアイコンID
     * Warp Prohibition Icon ID
     *   Icon ID when warp is prohibited */
    unsigned short forbiddenIconId;
